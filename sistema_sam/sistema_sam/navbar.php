    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <?php if($pg_atual == 'mostraReceita'): ?>
          <a class="nav-link active" aria-current="page" href="#">Receitas para Administrar</a>
        <?php else: ?>
          <a class="nav-link" href="mostraReceita.php">Receitas para Administrar</a>
        <?php endif; ?>
          
        </li>

        <li class="nav-item">
        <?php if($pg_atual == 'mostraAdministracao'): ?>
          <a class="nav-link active" aria-current="page" href="#">Receitas Administradas</a>
        <?php else: ?>
          <a class="nav-link" href="mostraAdministracao.php">Receitas Administradas</a>
        <?php endif; ?>
